...
impl AutoWC {
    ...
    fn create_output_for_window(&mut self, window_id: AutoWindowId) {
        ...
        let _global = output.create_global::<AutoWC>(&self.display_handle);
        update_output_mode(&output, self.initial_virtual_size.to_physical(1), 1.0);
        self.windows
            .get_mut(window_id)
            .expect("AutoWC window is missing")
